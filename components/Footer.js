...
const Footer = () => {
  return (
    <>
      <div
        className="flex flex-col md:flex-row gap-12 md:gap-0 justify-between items-center px-16 py-9 shadow-md border"
        style={{ zIndex: "10000" }}
      >
        <div className="flex justify-between items-center md:w-[60%] w-full flex-col md:flex-row  md:gap-8">
        ...
        <div className="flex justify-between md:w-[20%] w-full">
          <Link href={"/tos"}>
