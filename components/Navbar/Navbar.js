...
export default function Navbar() {
    return (
        <Disclosure as="nav" className={`${styles.main_container} bg-white`}>
            {({ open }) => (
                <>
                    <div className="mx-auto max-w-9xl px-2 sm:px-6 lg:px-8">
                        <div className="relative flex h-16 items-center justify-between">
                            ...
                            <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                                <div className="flex flex-shrink-0 items-center justify-center gap-7">
                                    <img className="block h-8 w-auto " src="/Images/logo.svg" alt="Logo" />
                                    <img className="block h-8 w-auto " src="/Images/BolStats.png" alt="Name" />
                                </div>
                                <div className="hidden sm:ml-6 sm:block">
